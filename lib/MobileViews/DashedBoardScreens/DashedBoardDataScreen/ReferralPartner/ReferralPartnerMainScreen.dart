...
import 'package:referral_admin_web/MobileViews/DashedBoardScreens/DashedBoardDataScreen/ReferralPartner/HeadingsContainer.dart';
import 'package:referral_admin_web/MobileViews/DashedBoardScreens/DashedBoardDataScreen/ReferralPartner/NewUserButton.dart';
import 'package:referral_admin_web/MobileViews/DashedBoardScreens/DashedBoardDataScreen/ReferralPartner/ReferralPartnersLiewViewContainer.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                PoppinText(
                    text: "Referral Partners", colour: blackColors, fs: 26),
